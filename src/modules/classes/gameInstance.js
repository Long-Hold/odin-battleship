export class Game {
   ...
   */
  getCurrentPlayer() {
    const playerOneTurnCount =
      this.playerOne.player.gameBoard.guessedSpaces.size;
    const playerTwoTurnCount =
      this.playerTwo.player.gameBoard.guessedSpaces.size;

    if (playerOneTurnCount === playerTwoTurnCount) return this.playerOne.player;
    else return this.playerTwo.player;
  }
}
